...
Tedarikci kalite ve uretim takip sistemi. Eski tek-dosya surumu (v1) kaldirildi;
bu depo artik dogrudan katmanli uygulamadir. Kimlik dogrulama kok `login.php` /
`logout.php` ile paylasilir (ayni `sessions` tablosu).
...
1. `config.php`'yi kok dizine koy: `['db_host','db_name','db_user','db_pass']`.
