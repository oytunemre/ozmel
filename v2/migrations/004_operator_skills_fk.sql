...
--
-- 002'de v2_operator_skills.operation_name SERBEST METIN idi (v1 mirasi). Artik
...
-- adlardan v2_operations(id) eslemesi yapip operation_id'yi doldurmak gerekir;
-- v2 tablolari henuz bos oldugu icin dogrudan yeniden yaziyoruz.

ALTER TABLE v2_operator_skills
  ...
  ADD CONSTRAINT fk_opskill_operation FOREIGN KEY (operation_id) REFERENCES v2_operations (id);
