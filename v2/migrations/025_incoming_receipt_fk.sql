...
--
-- 020'de v2_incoming_inspections satinalma girisini legacy_purchase_receipt_id
-- (CHAR(16) METIN) olarak tutuyordu, cunku satinalma girisleri tablosu henuz yoktu.
-- 024 ile v2_purchase_receipts geldi; artik gercek FK verilebilir.
--
-- purchase_receipt_id BIGINT eklenir ve v2_purchase_receipts(id)'ye FK (ON DELETE
...
ALTER TABLE v2_incoming_inspections
  ...
  ADD CONSTRAINT fk_ii_receipt FOREIGN KEY (purchase_receipt_id)
      REFERENCES v2_purchase_receipts (id) ON DELETE SET NULL;
