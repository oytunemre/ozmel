...
CREATE TABLE IF NOT EXISTS v2_routes (
  ...
  CONSTRAINT fk_route_product   FOREIGN KEY (product_code_id) REFERENCES v2_product_codes (id),
  CONSTRAINT fk_route_operation FOREIGN KEY (operation_id)    REFERENCES v2_operations    (id),
  CONSTRAINT fk_route_wc        FOREIGN KEY (work_center_id)  REFERENCES v2_work_centers  (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE IF NOT EXISTS v2_route_variants (
  id         BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  tenant_id  INT UNSIGNED    NOT NULL DEFAULT 1,
  legacy_id  VARCHAR(64)     NULL,
  ...
  CONSTRAINT fk_rvariant_route  FOREIGN KEY (route_id)  REFERENCES v2_routes (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
