...
final class HourlyPoint
{
    ...
    public static function fromRow(array $row): array
    {
        return [
            ...
            'measureLocation' => (string) $row['measure_location'],
    ...
    public static function toColumns(array $input): array
    {
        ...
        if (array_key_exists('measureLocation', $input)) {
            $out['measure_location'] = trim((string) $input['measureLocation']);
        }
