...
const DICT = {
  tr: {
    ...
    'rt.noActiveWarn': 'Bu adımda aktif hat seçili değil — kapasite hesaplanamaz.',
  ...
  en: {
    ...
    'rt.noActiveWarn': 'No active line selected for this step — capacity cannot be computed.',
